    ...
    class FlaUIDriverElement {
        ...
        public string GetHash() {
            ...
            return ((uint)(this.Properties.AutomationId + ";" + this.Properties.ClassName + ";" + this.Properties.Name +
                           ...
                           properties.AccessKey.ValueOrDefault + ";" + (object)properties.ControlType.ValueOrDefault +
                           ";" + (object)properties.ProcessId.ValueOrDefault + ";" +
                           (object)properties.BoundingRectangle.ValueOrDefault + ";").GetHashCode()).ToString();
        }
